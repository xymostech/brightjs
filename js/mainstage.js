...
var mainstage = ABXY.worldstage2d.Extend({
    ...
    OnLoad: function(game) {
        ...
        this.world.AddEntity(new Bright.forceblock(20, 20, "blue", true));
        ...
        this.world.AddEntity(new Bright.generator(140, 20, "right", "blue", true));
        this.world.AddEntity(new Bright.key(160, 20));
        this.world.AddEntity(new Bright.button(180, 20, "blue", true));
        ...
        this.world.AddEntity(new Bright.block(200, 60, "wood"));
        this.world.AddEntity(new Bright.block(180, 60, "wood"));
        this.world.AddEntity(new Bright.block(180, 40, "wood"));
    },
});
